...
The `inventory` application WAR file [hotspot=inventory-war file=0]`inventory.war`, which was created from running Maven `package`, is copied to the [hotspot=config-apps file=0]`/config/apps` destination directory.
